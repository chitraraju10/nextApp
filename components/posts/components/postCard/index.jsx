      ...
      <div className="bg-slate-100 m-5 rounded-lg">
        ...
        <div>
          <div className="flex justify-between p-3">
            ...
            <Popover width={200} position="left" withArrow shadow="md" opened={openPopover} onChange={setopenPopover}>
              <Popover.Target>
              ...
              <Popover.Dropdown>
                <div>
                  <button
                    ...
                    onClick={() => {setHandleDelete(true),setopenPopover(false)}}
                  >
                    <BsFillTrashFill className="mr-3 mt-1"/> Delete
                  </button>
                  <button
                    className="flex cursor-pointer text-lg"
                    onClick={() => {setOpened(true),setopenPopover(false)}}
                  >
                    <BsFillPencilFill className="mr-3 mt-1"/> Edit
                  </button>
                </div>
              </Popover.Dropdown>
            </Popover>
